...
import EducationAdminForm from './EducationAdminForm';
...
export default function EducationAdminList() {
  ...
  const fetchItems = async () => {
    try {
      ...
      toast.error(err instanceof Error ? err.message : 'Failed to load educations');
    } finally {
      setLoading(false);
    }
  };
          ...
          >
            <div className="flex-shrink-0 flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-zinc-700">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-bold">Manage Education</h2>
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6">
              {loading ? (
                ...
                <div className="text-center py-20 text-muted-foreground">
                  <p className="text-lg mb-2">No educations yet</p>
